...
等待完成后，检查 `[SESSION_DIR]/analysis_template.md` 是否生成。
...
等待完成后，检查 `[SESSION_DIR]/extracted_data.json` 是否生成。
...
prompt: "请根据模板分析和数据文件生成 [目标月份] 的统计报告。
...
原始模板：[模板文件名]
目标月份：[目标月份]
输出文件：./output/output_[目标月份]统计报告.docx
...
使用 Agent 工具：
- subagent_type: "template-analyst"
- prompt: "请分析模板文件 template.docx，生成模板分析文件到 [SESSION_DIR]/analysis_template.md"
```
...
使用 Agent 工具：
- subagent_type: "data-expert"
- prompt: "请根据模板分析文件 [SESSION_DIR]/analysis_template.md，从数据文件 data.xlsx 中提取 10月 的数据，保存到 [SESSION_DIR]/extracted_data.json"
```
...
使用 Agent 工具：
- subagent_type: "writer"
- prompt: "请根据模板分析文件 [SESSION_DIR]/analysis_template.md 和数据文件 [SESSION_DIR]/extracted_data.json，生成 10月 的统计报告到 output/output_10月统计报告.docx"
```
